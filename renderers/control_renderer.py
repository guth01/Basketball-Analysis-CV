...
class ControlRenderer:
    """
    Calculates and draws team ball control statistics on video frames.
    """
    ...
    def get_team_ball_control(self, player_assignment, ball_possession):
        ...
        """
        team_ball_control = []
        for player_assignment_frame, ball_possession_frame in zip(player_assignment, ball_possession):
    ...
    def draw(self, video_frames, player_assignment, ball_possession):
        """
