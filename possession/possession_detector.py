import sys
sys.path.append('../')
from helpers.geometry import measure_distance, get_center_of_bbox


class PossessionDetector:
    """
    Identifies which player controls the ball in each frame of a game sequence.
    """

    def __init__(self):
        """
        Initialize the PossessionDetector with default thresholds.
        """
